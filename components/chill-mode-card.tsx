        ...
        <CardContent className="p-6">
          <div className="text-center space-y-4">
            ...
            <h3 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100">
              ¿Listo para leer y relajarte?
            </h3>
            <p className="text-neutral-500 mb-6">
              Elige un versículo para comenzar tu lectura tranquila.
            </p>
            {onBrowseVerses && (
              <Button
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="text-center mb-4">
        ...
        <p className="text-sm text-neutral-500 mt-1">Modo de lectura progresiva</p>
      </div>
        ...
        {isCompleted ? (
          ...
          <div className="space-y-4">
            <div className="text-center text-sm text-neutral-600 dark:text-neutral-400 mb-4">
              Escribe cada palabra con precisión. Las letras incorrectas se ignoran y la puntuación final se completa automáticamente.
            </div>
            <InlineInput
              words={wordsArray}
      ...
      <div className="space-y-4">
        {!isCompleted ? (
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-neutral-600 dark:text-neutral-400">
              Terminaste de leer todo el pasaje palabra por palabra.
            </p>
            {onBrowseVerses && (
              <Button
                onClick={onBrowseVerses}
        ...
        <div className="text-center text-xs text-neutral-400 space-y-1">
          <p>✨ Las letras escritas se muestran en negrita; las restantes aparecen en gris.</p>
        </div>
      </div>
    </div>
  );
